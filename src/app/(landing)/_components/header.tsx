...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex  py-6 items-center px-4 md:px-0">
        ...
        <div className="flex w-1/3 items-center ml-auto justify-between space-x-2 md:justify-end">
          <div className="w-full md:w-auto md:flex-none flex">
            <PulsatingButton className="rounded-full" pulseColor="#bef264">
              Пробне тренування
            </PulsatingButton>
